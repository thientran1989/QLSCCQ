...
public class Tru_Fragment extends Fragment {
	...
	public static Tru_Fragment newInstance(String text){
		Tru_Fragment mFragment = new Tru_Fragment();
...
//		mFragment.setArguments(mBundle);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try{
            ...
            btn_them = (FloatingActionButton)rootView.findViewById(R.id.btn_add);
        }catch(Exception e){
...
//                        list_MBA = M_READ_JSON.read_list_MBA(mJO);
    ...
    public void set_list(List<Obj_TRU> list){
        if(list!=null) {
            mAdapter = new Adapter_TRU(getActivity(), list_donvi, list);
            recList.setAdapter(mAdapter);
            edt_search.setHint("Tim kiem trong " + list.size() + " diem");
        }
    }
    public void them_tru(){
