...
public class Tram_Fragment extends Fragment {
    ...
    public static List<Obj_TUYEN> list_tuyen =null;
    List<Obj_TRU> list_tru =null;
    List<Obj_donvi> list_donvi =null;
    SwipeRefreshLayout mSwipeRefreshLayout;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mReAdapter;
    Adapter_TRAM mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    RecyclerView recList;
    EditText edt_search;
    ProgressWheel prov;

	public static Tram_Fragment newInstance(String text){
		Tram_Fragment mFragment = new Tram_Fragment();
...
//                        list_MBA = M_READ_JSON.read_list_MBA(mJO);
    ...
    public void set_list(List<Obj_TRAM> list){
        if(list!=null) {
            mAdapter = new Adapter_TRAM(getActivity(), list);
